...
import static domain.Date.createDMY;
...
public class DateTest
{
    ...
    @Before 
    public void setUp() {
        this.date = createDMY( 1, 1, 2000 );
        dayInFebruariNonLeap = createDMY(1, 2, 2001);
        februari29Leap = createDMY(29, 2, 2000);
        lastdayInMarch = createDMY(31, 3, 2000);
        lastdayInApril = createDMY(30, 4, 2000);
    }
    
    //TEST CONSTRUCTOR
    @Test 
    public void test_Date_creates_date_for_valid_day_month_year_combinations() {
        date = createDMY( 1, 1, 2000 );

        assertEquals( 1, date.getDay() );
        assertEquals( 1, date.getMonth() );
        assertEquals( 2000, date.getYear() );
        
        date = createDMY( 29, 2, 2000 );
    ...
    private void checkComparison( int day1, int month1, int year1, int day2, int month2, int year2 ) {
        Date date1 = createDMY( day1, month1, year1 );
        Date date2 = createDMY( day2, month2, year2 );
    ...
    private void checkAdvanceSingleDay( int startDay, int startMonth, int startYear, int targetDay, int targetMonth, int targetYear ) {
        Date startDate = createDMY( startDay, startMonth, startYear );
        Date targetDate = createDMY( targetDay, targetMonth, targetYear );

        assertEquals( targetDate, startDate.advanceSingleDay() );
    }
    ...
    private void checkGoBackSingleDay( int startDay, int startMonth, int startYear, int targetDay, int targetMonth, int targetYear ) {
        ...
        assertEquals( targetDate, startDate.goBackSingleDay() );
    }
}
